...
این اسکریپت به شما کمک می‌کند چندین پروتکل مختلف پروکسی که در مقابل سیستم فیلترینگ GFI/GFW کارایی دارند را  بر روی سرور لینوکس خود **بدون نیاز به دامنه** راه‌اندازی نمایید.
...
```
apt install git
git clone https://github.com/kyochikuto/Rainb0w-Lite.git
