...
iptables -A INPUT -p tcp --dport 80 -m conntrack --ctstate NEW -m comment --comment "Allow HTTP 80" -j ACCEPT
ip6tables -A INPUT -p tcp --dport 80 -m conntrack --ctstate NEW -m comment --comment "Allow HTTP 80" -j ACCEPT
iptables -A INPUT -p tcp --dport 8080 -m conntrack --ctstate NEW -m comment --comment "Allow HTTP 8080" -j ACCEPT
ip6tables -A INPUT -p tcp --dport 8080 -m conntrack --ctstate NEW -m comment --comment "Allow HTTP 8080" -j ACCEPT
